...
export default function LoginPage({ onLogin, onBack }) {
  const [email,    setEmail]    = useState("admin@hematrix.com");
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        padding: "48px 56px", background: "#fafaf8",
        borderRight: "1px solid #f0f0f0", position: "relative", overflow: "hidden",
      }}>
        {/* dot grid */}
      ...
      {/* Right panel — form */}
      <div style={{ width: 480, display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", padding:"48px 56px", position:"relative", zIndex:1 }}>
        ...
        <div style={{ width:"100%", maxWidth:360 }}>
          ...
          <div style={{ marginBottom:24 }}>
            ...
            <p style={{ fontSize:13, color:"#9ca3af", marginBottom:10 }}>
              {isRegisterMode ? "Isi data di bawah untuk mendaftar akun Anda." : "Gunakan email dan password akun Anda"}
            </p>
            <button type="button" onClick={toggleMode} style={{ background:"none", border:"none", padding:0, color:"#2563eb", fontSize:12, fontWeight:700, cursor:"pointer", fontFamily:"inherit" }}>
          ...
          {isRegisterMode ? (
            <div style={{ display:"grid", gap:12 }}>
              ...
              <button type="button" onClick={handleRegister} disabled={regLoading} style={{ width:"100%", padding:"12px 0", borderRadius:10, border:"none", background: regLoading ? "#2563eb" : "#3b82f6", color:"#fff", fontSize:13, fontWeight:700, cursor: regLoading ? "not-allowed" : "pointer", fontFamily:"inherit", transition:"background .15s" }}>
            ...
            <button type="submit" disabled={loading} style={{
              ...
              fontFamily:"inherit", boxShadow:"0 0 0 4px rgba(22,163,74,.12)",
          ...
          {/* Info akun */}
          <div style={{ marginTop:28, padding:16, background:"#fafaf8", border:"1px solid #f0f0f0", borderRadius:10 }}>
            <div style={{ fontSize:11, color:"#9ca3af", fontWeight:600, marginBottom:10 }}>Akun demo</div>
            <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center" }}>
              <span style={{ fontSize:12, color:"#6b7280" }}>admin@hematrix.com</span>
              <span style={{ fontSize:11, background:"#f3f4f6", color:"#6b7280", padding:"3px 10px", borderRadius:6, fontWeight:600 }}>admin123</span>
            </div>
            <div style={{ fontSize:11, color:"#d1d5db", marginTop:10 }}>Tambah user di halaman Pengguna Sistem</div>
          </div>
        </div>
      </div>
